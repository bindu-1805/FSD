...
>
<option value="">Select Subject Code</option> <option value="CS641-cloud computing">CS641-cloud computing</option> <option value="CS642-Ethical Hacking">CS642-Ethical Hacking</option> <option value="CS644-Unix Programming">CS644-Unix Programming</option>
</select>
</div>
